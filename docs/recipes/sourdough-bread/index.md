...
!!! note
    ...
    Instead of using flour to keep things from sticking, we'll be using water. This helps in two ways, it prevents the dough from sticking to your hands but also allows it to stick to itself better. Adding more dough adds a dry later that might prevent it from binding to itself.

Place a large flat container on top of your digital scale and mist it with some water. We'll be using this to split our dough into two equal parts. Following the dough ingredient [weights](#dough) at the start of this recipe half the dough should be roughly 925g depending on how much levain was used.
...
Flip the dough onto your misted work surface (top-side up), using a [dough scraper](#optional-ingredients-tools) split the dough in half using the scale to ensure an even split. Any extra slivers of dough used to balance out the halves should be placed under our dough (remember, the top-side is preserved).
...
While the dough rests, we're going to prep our [bannetons](#optional-ingredients-tools).

!!! note

    It's recommended to use rice flour here but white flour should work as well.
    
    Also, the bannetons fabric liner is optional. Omitting it will allow for a more pronounced spiral texture on the final loaf.

Lightly mist your bannetons with water and let rest for a few seconds. This step will help the rice flour stick to the more vertical sides of the banneton. Finally, flour your bannetons.

### Shaping

After the dough has rested for 15 minutes. Roll each of them into a tight ball (preserving the top-side) and place top-side down into the banneton. This might initially feel nerve-racking but can be performed rather quickly without being too gentle.

### Second Proofing

Transfer each banneton into a [2 gallon sealable bag](#optional-ingredients-tools) and mist them with a few sprays of water to help maintain a humid environment. Place in the refrigerator, ideally both on the same shelf and proof overnight for ~24 hours.

### Baking the Dough

One hour before baking, preheat your oven to 500°F and place your [dutch oven](#optional-ingredients-tools) inside.

!!! tip

    Rather than placing a closed dutch oven into your place both the lid and body next to one another. Doing so will allow the dutch oven to heat up much faster.
...
TODO Place bread onto dutch oven
TODO Score bread
TODO Place back in oven
TODO Set timer for 20 minutes
TODO Remove lid, but keep inside the oven to help maintain temperature
TODO Set timer for 20 minutes
TODO Bread is ready when internal temp is 205-210F
-->
